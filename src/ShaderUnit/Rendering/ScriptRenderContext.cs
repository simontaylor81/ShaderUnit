...
namespace ShaderUnit.Rendering
{
	class ScriptRenderContext : IRenderContext
	{
		...
		public void DrawSphere(IShader vertexShaderInterface,
							   ...
							   ShaderUnit.Interfaces.DepthStencilState depthStencilState = null,
							   ShaderUnit.Interfaces.BlendState blendState = null,
									   ...
									   IEnumerable<object> renderTargetHandles = null)
		{
			...
			deviceContext.OutputMerger.DepthStencilState = _globalResources.DepthStencilStateCache.Get(ShaderUnit.Interfaces.DepthStencilState.DisableDepth.ToD3D11());
			deviceContext.OutputMerger.BlendState = _globalResources.BlendStateCache.Get(ShaderUnit.Interfaces.BlendState.NoBlending.ToD3D11());
			SetShaders(vertexShader, pixelShader);
